...
// Forward declare overlay::load_interface to satisfy call site
namespace overlay { void load_interface(); }
...
std::thread([] {
    while (true) {
        ...
        if (place == 9825515356ull) {
            ...
            globals::instances::gamename = "hood customs";
            globals::place_id = place;
            globals::instances::aim = playerGui
                .findfirstchild("Main Screen")
                .findfirstchild("Aim");
        }
        else if (place == 91222270589102ull) {
            globals::game = "zee hood";
            globals::instances::gamename = "zee hood";
            globals::place_id = place;
            globals::instances::aim = playerGui
                .findfirstchild("MainScreenGui")
                .findfirstchild("Aim");
        } 
        else if (place == 138995385694035ull) {
            globals::game = "hood customs ffa";
            globals::instances::gamename = "hood customs ffa";
            globals::place_id = place;
            globals::instances::aim = playerGui
                .findfirstchild("Main Screen")
                .findfirstchild("Aim");
        }
        else if (place == 90724401598574ull) {
            globals::game = "da track ffa";
            globals::instances::gamename = "da track ffa";
            globals::place_id = place;
            globals::instances::aim = playerGui
                .findfirstchild("MainUI")
                .findfirstchild("Aim");
        }
        else if (place == 75159825516372ull) {
            globals::game = "da track";
            globals::instances::gamename = "da track";
            globals::place_id = place;
            globals::instances::aim = playerGui
                .findfirstchild("Main")
                .findfirstchild("Aim");        
        }
        else if (place == 99148804220244ull) {
            globals::game = "model hood";
            globals::instances::gamename = "model hood";
            globals::place_id = place;
            globals::instances::aim = playerGui
                .findfirstchild("MainScreenGui")
                .findfirstchild("Aim");
        }
        else if (place == 80567999110374ull) {
            globals::game = "hood custom anarchy";
            globals::instances::gamename = "hood custom anarchy";
            globals::place_id = place;
            globals::instances::aim = playerGui
                .findfirstchild("Main Screen")
                .findfirstchild("Aim");
        }
        else if (place == 89562160011863ull) {
            globals::game = "der hood";
            globals::instances::gamename = "der hood";
            globals::place_id = place;
            globals::instances::aim = playerGui
                .findfirstchild("MainScreenGui")
                .findfirstchild("Aim");
        }
        else if (place == 286090429ull) {
            globals::game = "Arsenal";
