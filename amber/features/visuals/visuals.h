...
extern float original_fog_start;
extern float original_fog_end;
extern math::Vector3 original_fog_color;
extern bool original_fog_settings_saved;
extern std::mutex fog_mutex;
